import 'package:crown/features/channel/application/channel_video_provider.dart';
...
import 'package:crown/features/widgets/shimmer/videotapshimmer.dart';
...
class _VideoTabViewState extends ConsumerState<VideoTabView> {
  static const List<double> _heights = [220, 300, 260, 340, 210, 290, 250, 320, 230, 310, 270, 350];
        ...
        slivers: [
          ...
          if (state.isLoading && videos.isEmpty)
            const SliverFillRemaining(
              child: VideoAndMomentPageShimmer(),
            )
          else if (state.errorMessage != null && videos.isEmpty)
            SliverFillRemaining(
              child: OfflineView(
          ...
          else if (videos.isEmpty && !state.isLoading)
            SliverFillRemaining(
              hasScrollBody: false,
              child: Center(
                child: Text(
